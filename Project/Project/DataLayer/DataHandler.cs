...
namespace Project.DataLayer
{
    ...
    {
        string connection = @"Data Source=LAPTOP-GP8PMHCT;Initial Catalog=PRG282_Project;Integrated Security=True";
        ...
        public void MoUpdate(Module module)
        {
            ...
            string qUpdate = $"UPDATE Modules " +
                $"SET ModuleDescription = '{module.ModuleDescription1}', ModuleLink = '{module.ModuleLink1}' " +
